...
describe('PermissionsService', () => {
    ...
    describe('getRoles', () => {
        it('should fetch all roles', async () => {
            ...
            expect(apiClientMock.get).toHaveBeenCalledWith(`${baseUrl}/backoffice/roles`);
        });
    ...
    describe('createRole', () => {
        it('should create a new role', async () => {
            ...
            expect(apiClientMock.post).toHaveBeenCalledWith(`${baseUrl}/backoffice/roles`, request);
        });
    ...
    describe('addPermissionToRole', () => {
        it('should add permission to role using string id', async () => {
            ...
            const response = await lastValueFrom(service.addPermissionToRole(roleId, request));
    ...
    describe('assignRoleToUser', () => {
        it('should assign role to user using string id', async () => {
            ...
            const response = await lastValueFrom(service.assignRoleToUser(userId, request));
